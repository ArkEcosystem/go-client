...
func (s *DelegatesService) Get(ctx context.Context) (*http.Response, error) {
    resp, err := s.Client.Client.Get(s.Client.BaseURL.String() + "delegates/get")
...
func (s *DelegatesService) Count(ctx context.Context) (*http.Response, error) {
    resp, err := s.Client.Client.Get(s.Client.BaseURL.String() + "delegates/count")
...
func (s *DelegatesService) Fee(ctx context.Context) (*http.Response, error) {
    resp, err := s.Client.Client.Get(s.Client.BaseURL.String() + "delegates/fee")
...
func (s *DelegatesService) ForgedByAccount(ctx context.Context) (*http.Response, error) {
    resp, err := s.Client.Client.Get(s.Client.BaseURL.String() + "delegates/forging/getForgedByAccount")
...
func (s *DelegatesService) Search(ctx context.Context) (*http.Response, error) {
    resp, err := s.Client.Client.Get(s.Client.BaseURL.String() + "delegates/search")
...
func (s *DelegatesService) Voters(ctx context.Context) (*http.Response, error) {
    resp, err := s.Client.Client.Get(s.Client.BaseURL.String() + "delegates/voters")
...
func (s *DelegatesService) NextForgers(ctx context.Context) (*http.Response, error) {
    resp, err := s.Client.Client.Get(s.Client.BaseURL.String() + "delegates/getNextForgers")
