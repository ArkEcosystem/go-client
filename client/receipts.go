...
func (s *ReceiptsService) All(ctx context.Context, query *ReceiptsQuery) (*Receipts, *http.Response, error) {
...
func (s *ReceiptsService) Get(ctx context.Context, transactionHash string, query *ReceiptQuery) (*GetReceipt, *http.Response, error) {
...
func (s *ReceiptsService) Contracts(ctx context.Context, query *ReceiptContractsQuery) (*Receipts, *http.Response, error) {
	var responseStruct *Receipts
